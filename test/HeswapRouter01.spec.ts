...
enum RouterVersion {
  HeswapV2Router01 = 'HeswapV2Router01',
  HeswapV2Router02 = 'HeswapV2Router02'
}

describe('HeswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.HeswapV2Router01]: fixture.router01,
        [RouterVersion.HeswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.HeswapV2Router01]: 101876,
              [RouterVersion.HeswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.HeswapV2Router01]: 108770,
              [RouterVersion.HeswapV2Router02]: 108770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
